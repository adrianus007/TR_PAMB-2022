...
public final class NavHeaderHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView userProfilName;

  @NonNull
  public final CircleImageView userProfileImage;

  private NavHeaderHomeBinding(@NonNull LinearLayout rootView, @NonNull TextView userProfilName,
  ...
  public static NavHeaderHomeBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.user_profil_name;
      TextView userProfilName = ViewBindings.findChildViewById(rootView, id);
      if (userProfilName == null) {
        break missingId;
      }
      ...
      return new NavHeaderHomeBinding((LinearLayout) rootView, userProfilName, userProfileImage);
    }
